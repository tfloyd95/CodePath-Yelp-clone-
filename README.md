...
GIF created with [LiceCap](https://github.com/tfloyd95/CodePath-Yelp-clone-/blob/master/Yelp(clone).gif.

## Notes

Describe any challenges encountered while building the app. 
The challenge I experience while creating this app would have to be the autolayout. Although there was a walkthrough an error kept popping up on my screen which I had to continousy correct and cause the labels to appear anywhere on the screen.
